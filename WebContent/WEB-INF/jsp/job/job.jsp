	 	  ...
	 	  /** 给数据行绑定鼠标覆盖以及鼠标移开事件  */
	 	   ...
	 	   $("#delete").click(function(){
	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   $.ligerDialog.error("请选择一个需要删除的服务！");
	 		   }else{
	 			   /** 得到用户选中的所有的需要删除的ids */
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除服务",function(r){
	 				   if(r){
	 					   // alert("删除："+ids.get());
	 					   // 发送请求
...
<body>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
		...
		<td class="main_locbg font2"><img src="${ctx}/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：社区服务 &gt; 服务查询</td>
