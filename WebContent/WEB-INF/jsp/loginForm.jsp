...
<body style="font-family: 微软雅黑">
	<div class="page-lock">
		<div class="page-logo" style="margin-bottom: 2px">
			<a class="brand" href="loginForm.html"
				style="font-size: 22px; color: #FFF;"> 社区服务交流平台<font color="#FFCC00"></font><span
				...
				<div class="page-lock-info">
					...
					<c:choose>
						<c:when test="${requestScope.message == null }">
							<span style="padding-top: 5px">欢迎使用社区服务交流平台</span>
						</c:when>
						<c:otherwise>
